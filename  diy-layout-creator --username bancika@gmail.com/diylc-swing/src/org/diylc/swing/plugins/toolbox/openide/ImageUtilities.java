...
public final class ImageUtilities {
    ...
    private static final Image doMergeImages(Image image1, Image image2, int x, int y) {
        ...
        ToolTipImage buffImage = new ToolTipImage(str.toString(), model, model.createCompatibleWritableRaster(w, h), model.isAlphaPremultiplied(), null, null);
    ...
    extends RGBImageFilter {
        ...
        public int filterRGB(int x, int y, int rgb) {
            return (rgb & -16777216) + 8947848 + ((rgb >> 16 & 255) >> 2 << 16) + ((rgb >> 8 & 255) >> 2 << 8) + ((rgb & 255) >> 2);
        }
