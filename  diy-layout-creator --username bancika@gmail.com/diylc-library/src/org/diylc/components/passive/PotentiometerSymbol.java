...
@ComponentDescriptor(name = "Potentiometer Symbol", author = "MCbx", category = "Schematics", instanceNamePrefix = " VR", description = "Potentiometer symbol", stretchable = false, zOrder = IDIYComponent.COMPONENT, rotatable = true)
public class PotentiometerSymbol extends AbstractTransistorSymbol {
	...
	public void drawIcon(Graphics2D g2d, int width, int height) {
		...
		g2d.fill(new Polygon(new int[] { width / 2 - 4, width / 2 + 2, width / 2 - 2 },
				new int[] { height / 2 + 6, height / 2 + 6, height / 2 + 2 }, 3));
	}
