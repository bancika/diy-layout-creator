...
public class ManageProjectsAction extends AbstractAction {
  private static final long serialVersionUID = 1L;
  private final CloudPlugIn cloudPlugIn;

  public ManageProjectsAction(CloudPlugIn cloudPlugIn) {
    super();
  ...
  public void actionPerformed(ActionEvent e) {
    cloudPlugIn.createUploadManagerFrame().setVisible(true);
  }
} 
