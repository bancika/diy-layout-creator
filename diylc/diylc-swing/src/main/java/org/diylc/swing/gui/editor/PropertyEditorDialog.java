  ...
  public PropertyEditorDialog(JFrame owner, List<PropertyWrapper> properties, String title,
    ...
    Action escapeAction = new AbstractAction() {
      ...
      public void actionPerformed(ActionEvent e) {
        getButton(ButtonDialog.CANCEL).doClick();
      }
    };
    getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(escapeStroke,
        "PropertyEditorDialog.escape");
    getRootPane().getActionMap().put("PropertyEditorDialog.escape", escapeAction);
  }
