...
public class Tree {
  ...
  private List<String> toAscii() {
    if (leaf != null) {
      return Arrays.asList(TreeAsciiUtil.generateString("&boxh;", 3) + " " + leaf.toHTML() + " " + TreeAsciiUtil.generateString("&boxh;", 3));
    }
    ...
    if (TreeConnectionType.Series.equals(connectionType)) {
      return TreeAsciiUtil.concatenateMultiLineSerial(TreeAsciiUtil.generateString("&boxh;", 5), childrenAscii);
    } else {
