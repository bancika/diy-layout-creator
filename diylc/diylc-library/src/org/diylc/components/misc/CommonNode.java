...
@ComponentDescriptor(name = "Common Node", author = "Branislav Stojkovic", category = "Misc",
    description = "Label that ties all nodes together", instanceNamePrefix = "CN", zOrder = IDIYComponent.TEXT, flexibleZOrder = true,
...
public class CommonNode extends AbstractComponent<String> implements ICommonNode {  
  ...
  public void draw(Graphics2D g2d, ComponentState componentState, boolean outlineMode, Project project,
    ...
    RoundRectangle2D rect = new RoundRectangle2D.Double(x - stringBounds.getWidth() / 2 - BUFFER, 
        y - stringBounds.getHeight() / 2 - BUFFER, stringBounds.getWidth() + 2 * BUFFER, stringBounds.getHeight() + 2 * BUFFER, 
        stringBounds.getHeight() / 2, stringBounds.getHeight() / 2);
    ...
    StringUtils.drawCenteredText(g2d, text, x, y, HorizontalAlignment.CENTER, VerticalAlignment.CENTER);    
  }
