...
@ComponentDescriptor(name = "Voltage Source", author = "JD", category = "Schematic Symbols",
    creationMethod = CreationMethod.POINT_BY_POINT, instanceNamePrefix = "V", description = "Voltage Source schematic symbol",
    zOrder = IDIYComponent.COMPONENT)

/** Component type for Voltage Source Symbol, options for both AC and DC. 
 *  Modified from the Battery Symbol component.
 *  Author: JD
 * 
 * @author JD
 */
public class VoltageSourceSymbol extends AbstractSchematicLeadedSymbol<String> {
  ...
  /** Returns whether the source is AC or DC.
   *  Uses Enum "SourceType"
  ...
  /** Sets whether the source is AC or DC.
   *  Uses Enum "SourceType"
   *  Author: JD (Modified Bancika's code, credit to Bancika)
   * @param source_Type
   */
