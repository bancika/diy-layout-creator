...
public class JumboTubeSocketTransformer implements IComponentTransformer {

  @Override
  public boolean canRotate(IDIYComponent<?> component) {
    return Jumbo4PinTubeSocket.class.isAssignableFrom(component.getClass());
  }
  ...
  public void rotate(IDIYComponent<?> component, Point2D center, int direction) {
    ...
    Jumbo4PinTubeSocket tube = (Jumbo4PinTubeSocket) component;
