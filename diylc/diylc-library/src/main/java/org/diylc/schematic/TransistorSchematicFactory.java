...
/**
 * Maps physical transistor packages (TO-92, TO-220, TO-3, TO-126, TO-1) to a {@link BJTSymbol}. The
 ...
 */
public class TransistorSchematicFactory extends AbstractSimpleSchematicFactory {

  @Override
  protected IDIYComponent<?> createSymbol() {
    return new BJTSymbol();
  }
