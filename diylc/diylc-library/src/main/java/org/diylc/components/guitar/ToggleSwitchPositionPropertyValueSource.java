...
public class ToggleSwitchPositionPropertyValueSource extends AbstractDynamicPropertyValueSource {
  ...
  public List<Object> getAvailableValues() {
    ...
    ToggleSwitchType
        switchType = (ToggleSwitchType) optionalPropertyWrapper.get().getValue();
