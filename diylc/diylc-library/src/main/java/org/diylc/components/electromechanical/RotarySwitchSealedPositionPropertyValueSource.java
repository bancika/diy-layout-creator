...
public class RotarySwitchSealedPositionPropertyValueSource
  ...
  public List<Object> getAvailableValues() {
    ...
    RotarySwitchSealedType switchType =
        (RotarySwitchSealedType) optionalPropertyWrapper.get().getValue();
    return SwitchPositionPropertyValueSource.positions(switchType.getPositionCount());
  }
}
