...
public class MultimeterProbe extends AbstractTransparentComponent<Color> {
  ...
  public Shape[] getBody() {
    if (body == null) {
      ...
      body[0] = probe;
      Path2D handle =
          buildHandleShape(probeDiameter, probeLength, handleDiameter, handleLength, x, y);
      body[1] = handle;
  ...
  private Path2D buildHandleShape(double probeDiameter, double probeLength, double handleDiameter,
      double handleLength, double x, double y) {
