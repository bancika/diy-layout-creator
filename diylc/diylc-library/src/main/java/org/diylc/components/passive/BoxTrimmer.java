...
public class BoxTrimmer extends AbstractTransparentComponent<Resistance> {
  ...
  public static Color SCREW_COLOR = BRASS_COLOR;
  ...
  public void draw(Graphics2D g2d, ComponentState componentState, boolean outlineMode,
    ...
    if (!outlineMode) {
      ...
      g2d.fillRect(slotCenterX - slotLength / 2, slotCenterY - slotThickness / 2, slotLength,
          slotThickness);
    }
    ...
    String label = display == Display.NAME ?
        getName() :
