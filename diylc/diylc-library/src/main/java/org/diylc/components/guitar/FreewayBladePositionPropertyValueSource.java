...
public class FreewayBladePositionPropertyValueSource extends
  ...
  public List<Object> getAvailableValues() {
    ...
    FreewayBlade.FreewayBladeType switchType = (FreewayBlade.FreewayBladeType) optionalPropertyWrapper.get()
        .getValue();
