...
public class GuitarPickupTransformer implements IComponentTransformer {

  @Override
  public boolean canRotate(IDIYComponent<?> component) {
    return AbstractGuitarPickup.class.isAssignableFrom(component.getClass());
  }
  ...
  public void rotate(IDIYComponent<?> component, Point2D center, int direction) {
    ...
    AbstractGuitarPickup pickup = (AbstractGuitarPickup) component;
    Orientation o = pickup.getOrientation();
