...
import org.diylc.components.electromechanical.RotarySwitchType;
...
public abstract class RotarySwitchTests extends AbstractSwitchTests {
  ...
  public void testRotarySwitchSP12T() {
    ...
    sw.setValue(RotarySwitchType._1P12T);
  ...
  public void testRotarySwitchDP6T() {
    ...
    sw.setValue(RotarySwitchType.DP6T);
    testSwitch(sw, validCombinations);
  }
  ...
  public void testRotarySwitch3P4T() {
    ...
    sw.setValue(RotarySwitchType._3P4T);
    testSwitch(sw, validCombinations);
  }
  ...
  public void testRotarySwitch4P3T() {
    ...
    sw.setValue(RotarySwitchType._4P3T);
    testSwitch(sw, validCombinations);
  }
}
