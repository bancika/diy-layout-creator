...
public class CapacitorDimensionServiceTests {
  ...
  public void testMissingType() {
    Assert.assertNull(CapacitorDimensionService.getInstance().lookup(AxialFilmCapacitor.class,
  ...
  public void testExactValue63v() {       
    CapacitorDimensions dim = CapacitorDimensionService.getInstance().lookup(AxialFilmCapacitor.class,
    ...
    Assert.assertEquals(new Size(6d, SizeUnit.mm).convertToPixels(), dim.getDiameter(), 0.0001);
  }
